...
class ProfilePage(BasePage):
    ...
    _first_ended_transaction_submit_commentary_button = (By.XPATH, "//div[3]/div[2]")
    _commentaries_menu = (By.XPATH, "//a[5]/h4")
    _first_transaction_send_commentary_button = (By.XPATH, "//td[4]/div/a")
    ...
    _first_transaction_submit_commentary_button = (By.XPATH, "//div[3]/div[2]")
    ...
    _provider_first_sent_commentary_field = (By.XPATH, "//td")
    _provider_first_sent_commentary_consignment_uuid = (By.XPATH, "//td[2]/a")
    ...
    _provider_send_commentary_button = (By.XPATH, "/html/body/div[8]/div[7]/div[2]/div[2]/table/tbody/tr[1]/td[4]/div/a")
    ...
    _provider_send_commentary_submit_button = (By.XPATH, "//div[3]/div[2]")
    ...
    _my_offers_send_commentary_button = (By.XPATH, "/html/body/div[8]/div[7]/div[2]/div[2]/table/tbody/tr[1]/td[5]/div/div[3]/a")
    ...
    _ask_for_offers_button = (By.XPATH, "//td[5]/div/div/a")
    ...
    def edit_user_profile(self):
        ...
        self.click(self._my_data_country_dropdown)
    ...
    def edit_provider_profile(self):
        ...
        while True:
            try:
                ...
                break
        self.click(self._provider_country_dropdown)
        self.click(self._provider_random_country_button)
        while True:
            try:
    ...
    def provider_send_commentary_from_commentaries_menu(self):
        ...
        self.click(self._provider_send_random_commentary_type_button)
    ...
    def enter_provider_sent_commentaries_tab(self):
        self.click(self._provider_sent_commentaries_tab)
    ...
    def user_send_commentary_from_commentaries_menu(self):
        ...
        self.click(self._first_transaction_random_commentary_type_button)
    ...
    def user_send_negative_commentary(self):
        self.click(self._commentaries_menu)
        self.click(self._first_transaction_send_commentary_button)
        self.click(self._first_transaction_negative_commentary_type_button)
        self.clear_field_and_send_keys("This is my negative commentary", self._first_transaction_commentary_content)
        self.click(self._first_transaction_submit_commentary_button)
